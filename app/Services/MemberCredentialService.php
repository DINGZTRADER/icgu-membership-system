...
final class MemberCredentialService
{
    ...
    public function renderSvg(Member $member, MemberCredential $credential): string
    {
        ...
        $verifyUrl = $this->xml(rtrim((string) config('app.url'), '/').'/api/membership/verify/'.$credential->verification_code);

        if ($credential->credential_type === 'certificate') {
            return <<<SVG
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="800" viewBox="0 0 1200 800">
  <rect width="1200" height="800" fill="#ffffff"/>
  <rect x="24" y="24" width="1152" height="752" rx="18" fill="none" stroke="#13294b" stroke-width="8"/>
  <rect x="42" y="42" width="1116" height="716" rx="12" fill="none" stroke="#b89b5e" stroke-width="2"/>
  <text x="600" y="135" text-anchor="middle" font-family="Georgia,serif" font-size="58" font-weight="700" fill="#13294b">ICGU</text>
  ...
  <text x="600" y="295" text-anchor="middle" font-family="Georgia,serif" font-size="46" fill="#13294b">Membership Certificate</text>
  <text x="600" y="365" text-anchor="middle" font-family="Arial,sans-serif" font-size="22" fill="#5d6775">This certifies that</text>
  <text x="600" y="430" text-anchor="middle" font-family="Georgia,serif" font-size="42" font-weight="700" fill="#13294b">{$name}</text>
  <text x="600" y="485" text-anchor="middle" font-family="Arial,sans-serif" font-size="24" fill="#5d6775">{$plan}</text>
  <text x="600" y="545" text-anchor="middle" font-family="Arial,sans-serif" font-size="22" fill="#13294b">Membership No. {$number}</text>
  <text x="600" y="585" text-anchor="middle" font-family="Arial,sans-serif" font-size="20" fill="#13294b">Valid until {$validUntil}</text>
  <line x1="220" y1="635" x2="980" y2="635" stroke="#b89b5e" stroke-width="2"/>
...
<svg xmlns="http://www.w3.org/2000/svg" width="1000" height="600" viewBox="0 0 1000 600">
  <rect width="1000" height="600" rx="36" fill="#13294b"/>
  <rect x="24" y="24" width="952" height="552" rx="28" fill="none" stroke="#b89b5e" stroke-width="3"/>
  ...
  <text x="70" y="250" font-family="Arial,sans-serif" font-size="22" fill="#b89b5e">MEMBERSHIP CARD</text>
